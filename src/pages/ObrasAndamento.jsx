...
import * as S from './ObrasAndamento.styles.jsx'
...
function ObrasConcluidas() {
  ...
  return (
    <S.Page>
      <S.HeroWrapper>
        <S.HeroImage>
          <img src={heroImg} alt="Obras em Andamento" />
        </S.HeroImage>
        <S.HeroBadge>OBRAS EM ANDAMENTO</S.HeroBadge>
      </S.HeroWrapper>

      <S.IntroSection>
        <S.IntroContent>
          <p>
           PAGINA EM CONSTRUÇÃO - Em breve você poderá conferir nossos projetos em andamento.
          </p>
        </S.IntroContent>
      </S.IntroSection>
